...
export default function IndustriesTable() {
    ...
    // 👉 FETCH INDUSTRY LIST WITH PAGINATION
    const allIndustries = useGetAllIndustry(page, limit);
    const industries = allIndustries.data?.data || [];
    const meta = allIndustries.data?.meta;
    const isLoading = allIndustries.isLoading;
        ...
        if (deleteTarget) {
            deleteMutation.mutate(deleteTarget._id, {
                onSuccess: () => {
                    ...
                    allIndustries.refetch(); // 🔥 refresh table after delete
                },
            });
        }
    };
