    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 bg-white/85 backdrop-blur-sm rounded-2xl shadow-md p-8 sm:p-10 w-full max-w-[500px]">
                <div className="mb-10">
                    <h3 className="text-[#00383B] text-center text-[40px] ">Change Password</h3>
                ...
                <div className="flex items-center justify-center  bg-background ">
                    <div className="w-full  bg-card rounded-lg  ">
                        ...
                        <Button
                            ...
                            className="w-full bg-[#00383B] hover:bg-[#00383B]/50 text-white font-semibold py-2 rounded-md transition-colors"
                        >
